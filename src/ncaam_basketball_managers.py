...
class BaseNCAAMBasketballManager(Basketball):
    ...
    def _fetch_ncaam_basketball_api_data(
        ...
        request_id = self.background_service.submit_fetch_request(
            sport="ncaa_mens_basketball",  # or "ncaa_womens_basketball"
            year=season_year,
            url=ESPN_NCAAMB_SCOREBOARD_URL,  # or ESPN_NCAAWB_SCOREBOARD_URL
            cache_key=cache_key,
            params={"dates": date_range, "limit": 500, "groups": 50},  # ← FIXED
